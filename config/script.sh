...
then	
	...
	head -n 2 /home/$user/.ssh/authorized_keys | sudo tee /home/$user/.ssh/authorized_keys
	head -n 2 /home/$user/.ssh/known_hosts | sudo tee /home/$user/.ssh/known_hosts
fi
...
if [ "$j" -eq 1 ]
then 
	tail -n $((n+2)) /home/$user/.ssh/authorized_keys > newkeys.txt
else
